...
Designing a Rule-Based AI for Smart Greenhouse Decision Support System Scenario: 

In a semi-arid region of Kenya, a cooperative of small-scale farmers is adopting AI-assisted greenhouse farming to improve food production.
...
# Task
Write a modular high-level code or pseudo-code to: 

1. Simulate real-time environmental input over 10 intervals.
