...
#
#displays randomly chosen list
for i, data in enumerate(test_random):
    print(f"Interval {i+1}: Temperature={data[0]}°C, Humidity={data[1]*100}%, "
          f"CO2={data[2]}ppm, Moisture={data[3]*100}%, Light={data[4]} lux") 

#allows for the list to be shuffled,then iterates through each
print("/n--- Calling check_alerts with individual unpacking ---")
