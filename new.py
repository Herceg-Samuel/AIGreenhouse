...
print(" System Processing Test Scenarios ")
for i, data in enumerate(test_random):
    temp, hum, CO, moisture, light = data
    ...
    print(f"Conditions: Temperature={temp}°C, Humidity={hum*100}%, "
          f"CO2={CO}ppm, Moisture={moisture*100}%, Light={light} lux")
